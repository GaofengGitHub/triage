...
public class DateUtil {
	...
	public static SimpleDateFormat monthMatter=new SimpleDateFormat("yyyyMM");
	
	
	public static String monthReduce(int num){
		 Calendar calendar = Calendar.getInstance();
	      //获取当前时间的前6个月
	      calendar.add(Calendar.MONTH,-num);
	      Date date02 = calendar.getTime();
	      return new BigDecimal(monthMatter.format(date02)).toString();
	}
