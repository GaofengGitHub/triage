$(document).ready(function() {
	//单选按钮
	$(".common-radio .checked-static").click(function(){
		$(this).parents(".common-radio").addClass("active").siblings().removeClass("active");
		$(this).find("input").attr("checked",true);
	});
	//单选按钮点击文字选中
	$(".common-radio label").click(function(){
			...
			.bootstrapTable(
					{
						...
						columns : [
								...
								},
								{
									...
									formatter : function(value, row, index) {
										var strhtml = '';
										strhtml += '<button id='+row.id+' Userbehavior="A61" type="button" class="btn btn-info btn-look" onclick="show(&quot;'
												+ row.id
												+ '&quot;,&quot;'
												+ row.name
												+ '&quot;,&quot;'
