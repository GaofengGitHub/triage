...
function initPre(){
		...
		// $('#wait-patients tbody tr:first
		// td').eq(5).attr('rowspan','1').attr('colspan','3');
        ...
        columns: [{
            ...
            formatter:function(value,row,index){    
                ...
                if(row.teshu ==null ||row.teshu ==''){
                	strhtml += '<button style="color:#ccc;" class="hover-parent version-hide" e_name="index_all_patients_table_specail"><i class="fa fa-star" Userbehavior="A4" onclick="baote(&quot;'+badtype+'&quot;);"></i><b class="hover-content">报特殊</b></button>';
            	}else{
            		strhtml += '<button class="red hover-parent version-hide" e_name="index_all_patients_table_specail"><i class="fa fa-star" Userbehavior="A4" onclick="baote(&quot;'+badtype+'&quot;);"></i><b class="hover-content">报特殊</b></button>';
            	}
				return strhtml;    
            }
        },{
...
// case '1':
// //alert(11);
// strhtml+='<button type="button" class="btn btn-1001 btn-1001-selected btn-xs
// ">'+name+'</button>';
// break;
// case '2':
// strhtml+='<button type="button" class="btn btn-1002 btn-1002-selected btn-xs
// ">'+name+'</button>';
// break;
// case '3':
// strhtml+='<button type="button" class="btn btn-1003 btn-1003-selected btn-xs
// ">'+name+'</button>';
// break;
// case '4':
// strhtml+='<button type="button" class="btn btn-1004 btn-1004-selected btn-xs
// ">'+name+'</button>';
// break;
// case '5':
// strhtml+='<button type="button" class="btn btn-1005 btn-1005-selected btn-xs
// ">'+name+'</button>';
// break;
// default:
...
// }else{
// strhtml += '<span class="red"><i class="fa fa-star"
// title="'+row.addr+'"></i></span>'+ row.fullname;
// specialadd();
// }
// if(row.fullname=='无名氏'){
...
// },
          ...
          formatter:function(value,row,index){    
        	  var fullname = '';
	          	if(row.teshu ==null ||row.teshu ==''){
	          		...
	          		fullname += '<span class="red"><i class="fa fa-star" title="'+row.addr+'"></i></span>'+ row.fullname;
	          		specialadd();
	          	}
	          	if(row.fullname.indexOf('无名氏')> -1 ){
	        		fullname ='  <span class="table-idlable">'+value+'</span>';
	        	}
	          	if(row.fullname=='无名氏'){
	          		fullname +='     <span class="table-idlable">'+row.id+'</span>';
	          	}
	          	
	          	var age = '';
	          	if(row.age==''||value==null){
	          		age = jsGetAge('', row.bornday);
	          		if(age==''){
	          			age='0天';
	          		}
	          	}else{
            	...
            	var gender = '';
            	if(row.gender=='1'){
            		gender="<div class='gender man'><img src='#path()/static/vendor/newpage/images/home/fzHome_man.png'/></div>";
            	}else if(row.gender=='2'){
            		gender="<div class='gender woman'><img src='#path()/static/vendor/newpage/images/home/fzHome_woman.png'/></div>";
            	}else if(row.gender=='9'){
            		gender="<div class='gender man'>未说明</div>";
            	}else{
            		gender=row.gender;
            	}
          	
            	var strhtml = '<div class="Selfinfo">';
				strhtml += "<span>"+fullname +"</span><span>" + age +"</span>";
				strhtml += gender;
				return strhtml+"</div>";
        ...
        }, 
        {
            ...
            formatter:function(value,row,index){    
            	...
            	/*
				 * if(row.special==0){ strhtml += '<span style="color:black;" ><i
				 * class="fa fa-star"
				 * onclick="saveSpecial(&quot;是否标记为特殊人员&quot;,&quot;'+ row.id
				 * +'&quot;,&quot;'+row.cardnum +'&quot;);"></i></span>';
				 * }else{ strhtml += '<span class="red" ><i class="fa fa-star"
				 * onclick="saveSpecial(&quot;是否取消标记为特殊人员&quot;,&quot;'+ row.id
				 * +'&quot;,&quot;'+row.cardnum +'&quot;);"></i></span>'; }
				 */
...
//            	}
				...
				if(row.cixu>1){
                	strhtml += '<button class="btn hover-parent version-hide btnbg_look" e_name="index_wait_patients_table_edit"><span class="setIcon iconWrite" Userbehavior="A16" onclick="openDivid2(&quot;'+row.id +'&quot;)"></span><b class="hover-content">查看/修改</b></button>';
            	}else{
                	strhtml += '<button class="btn hover-parent version-hide btnbg_look" e_name="index_wait_patients_table_edit"><span class="setIcon iconWrite" Userbehavior="A16" onclick="openDivid(&quot;'+row.id +'&quot;)"></span><b class="hover-content">查看/修改</b></button>';
            	}
            	
            	strhtml += '<button class="btn hover-parent version-hide btnbg_del" e_name="index_wait_patients_table_del"><span class="setIcon iconDel" Userbehavior="A6" onclick="backPatient(&quot;是否确认删除患者本次就诊信息，将患者从系统中删除？&quot;,&quot;'+row.id +'&quot;,&quot;'+row.hisid +'&quot;,&quot;'+row.cardnum +'&quot;,&quot;'+row.eventid +'&quot;);"></span><b class="hover-content">删除</b></button>';
				return strhtml;    
            }
        }, ]
    });
...
//        	width:42,
            formatter:function(value,row,index){    
				...
				badtype+=row.teshu
                if(row.teshu ==null ||row.teshu ==''){
                	strhtml += '<button style="color:#ccc;" class="hover-parent version-hide" e_name="index_all_patients_table_specail"><i class="fa fa-star" Userbehavior="A7" onclick="baote(&quot;'+badtype+'&quot;);"></i><b class="hover-content">报特殊</b></button>';
            	}else{
            		strhtml += '<button class="red hover-parent version-hide" e_name="index_all_patients_table_specail"><i class="fa fa-star" Userbehavior="A7" onclick="baote(&quot;'+badtype+'&quot;);"></i><b class="hover-content">报特殊</b></button>';
            	}
				return strhtml;    
            }
        },{
...
//            width:103,
            formatter:function(value,row,index){    
				...
				switch(grade)
				{
				    case '1':
				    	// alert(11);
				    	strhtml+='<button type="button" class="btn btn-1001   btn-1001-selected btn-xs btn-my ">'+name+'级'+'</button>';
				        break;
				    case '2':
				    	strhtml+='<button type="button" class="btn btn-1002   btn-1002-selected btn-xs btn-my ">'+name+'级'+'</button>';
				        break;
				    case '3':
				    	strhtml+='<button type="button" class="btn btn-1003  btn-1003-selected  btn-xs btn-my ">'+name+'级'+'</button>';
				        break;
				    case '4':
				    	strhtml+='<button type="button" class="btn btn-1004   btn-1004-selected btn-xs btn-my">'+name+'级'+'</button>';
				        break;
				    case '5':
				    	strhtml+='<button type="button" class="btn btn-1005  btn-1005-selected btn-xs btn-my">'+name+'级'+'</button>';
				        break;
				    default:
				    	strhtml+='<button type="button" class="btn btn-primary btn-xs">未分级</button>';
				}
...
//            	}
            	...
            	strhtml += '<button class="btn hover-parent version-hide btnbg_sign" e_name="index_divid_patients_table_ralationsign"><span class="setIcon iconDis" Userbehavior="A8" onclick="showsign(&quot;'+row.signurl +'&quot;)"></span><b class="hover-content">家属签字</b></button>';
            	
            	strhtml += '<button class="btn hover-parent version-hide btnbg_look" e_name="index_divid_patients_table_edit"><span class="setIcon iconWrite" Userbehavior="A9" onclick="openDivid2(&quot;'+row.id +'&quot;)"></span><b class="hover-content">查看/修改</b></button>';
            	if(is_print!='已关闭'){
                	strhtml += '<button class="btn hover-parent version-hide btnbg_print" e_name="index_divid_patients_table_print"><span class="list-print-icon" onclick="dayindividshow(&quot;'+row.id +'&quot;);"></span><b class="hover-content">打印分诊单</b></button>';
            	}
            	// strhtml += '<span class="setIcon iconDel"
				// onclick="backPatient2(&quot;是否确认删除患者分诊信息，将患者退回‘待分诊’状态？&quot;,&quot;'+row.id
				// +'&quot;,&quot;'+row.status +'&quot;,&quot;'+row.hisid
				// +'&quot;,&quot;'+row.cardnum +'&quot;);"></span>';
            	if(is_receive!='已关闭'){
                	strhtml += '<button class="btn hover-parent version-hide btnbg_do" e_name="index_divid_patients_table_receive"><span class="setIcon iconTriage" Userbehavior="A10" onclick="receive(&quot;标记已接诊&quot;,&quot;'+ row.id +'&quot;,&quot;'+row.dividtime +'&quot;,&quot;'+row.hisid +'&quot;,&quot;'+row.cardnum +'&quot;,&quot;'+row.savestatus +'&quot;);" id="receive" value=""></span><b class="hover-content">接诊</b></button>';

            	}
// if((grade =='3' || grade=='4') && row.go_rct !='1'){
// strhtml += '<span class="setIcon iconTriage" Userbehavior="A10"
// onclick="receive(&quot;标记已接诊&quot;,&quot;'+ row.id
// +'&quot;,&quot;'+row.dividtime +'&quot;,&quot;'+row.hisid
// +'&quot;,&quot;'+row.cardnum +'&quot;,&quot;'+row.savestatus +'&quot;);"
// id="receive" value=""></span>';
// }else{
// strhtml += '<span class="setIcon " Userbehavior="A10" id="receive"
// value=""></span>';
//
// }
...
//        	width:45,
            formatter:function(value,row,index){    
				...
				badtype+=row.teshu
                if(row.teshu ==null ||row.teshu ==''){
                	strhtml += '<button style="color:#ccc;" class="hover-parent version-hide" e_name="index_all_patients_table_specail"><i class="fa fa-star" Userbehavior="A14" onclick="baote(&quot;'+badtype+'&quot;);"></i><b class="hover-content">报特殊</b></button>';
            	}else{
            		strhtml += '<button class="red hover-parent version-hide" e_name="index_all_patients_table_specail"><i class="fa fa-star" Userbehavior="A14" onclick="baote(&quot;'+badtype+'&quot;);"></i><b class="hover-content">报特殊</b></button>';
            	}
				return strhtml;    
            }
        },{
...
//            	}
            	...
            	strhtml += '<button class="btn hover-parent version-hide btnbg_sign" e_name="index_receive_patients_table_ralationsign"><span class="setIcon iconDis" Userbehavior="A12" onclick="showsign(&quot;'+row.signurl +'&quot;)"></span><b class="hover-content">家属签字</b></button>';
            	strhtml += '<button class="btn hover-parent version-hide btnbg_look" e_name="index_receive_patients_table_edit"><span class="setIcon iconWrite" Userbehavior="A13" onclick="openDivid2(&quot;'+row.id +'&quot;)"></span><b class="hover-content">查看/修改</b></button>';
            	// strhtml += '<span class="setIcon iconDel"
				// onclick="backPatient2(&quot;是否确认删除患者本次就诊信息，将患者从系统中删除？&quot;,&quot;'+row.id
				// +'&quot;,&quot;'+row.status +'&quot;,&quot;'+row.hisid
				// +'&quot;,&quot;'+row.cardnum +'&quot;);"></span>';
				return strhtml;    
            }
...
//        	width:45,
            title: '序号',
            formatter:function(value,row,index){    
            	var pageSize = $('#all-patients').bootstrapTable('getOptions').pageSize;     // 通过table的#id
																								// 得到每页多少条
                var pageNumber = $('#all-patients').bootstrapTable('getOptions').pageNumber; // 通过table的#id
																								// 得到当前第几页
...
//        }, 
        {field : 'fullname', 
//        	width:160,
        	title : '个人信息',formatter:function(value,row,index){
			        	var fullname = '';
			        	if(row.teshu ==null ||row.teshu ==''){
			        		fullname += ''+ row.fullname+'';
			        	}else{
...
//		            		gender=row.gender;
		            	...
		            	var status = '';
		            	if(row.status=='未分诊'){
		            		status +='<div class="fenzhen" style=" background-color: #999; ">待分诊</span>';
		            	}else if(row.status=='未接诊'){
		            		status +='<div class="fenzhen" style=" background-color: #999; ">已分诊</div>';
		            	}else if(row.status=='已接诊'){
		            		status +='<div class="fenzhen" style=" background-color: #999; ">已接诊</div>';
		            	}else{
		            		status +=row.status;
		            	}
		            	
			var strhtml = '<div class="Selfinfo">';
			strhtml += "<span>"+ fullname +"</span><span>" +  row.age  +"</span>";
			strhtml += gender  +status;
			return strhtml+"</div>";
			}
        },
        {
...
//            width:308,
            formatter:function(value,row,index){    
            	...
            	if(row.status !='未分诊'){
            		/*
					 * if(row.special==0){ strhtml += '<span
					 * style="color:black;" ><i class="fa fa-star"
					 * onclick="saveSpecial(&quot;是否标记为特殊人员&quot;,&quot;'+
					 * row.id +'&quot;,&quot;'+row.cardnum +'&quot;);"></i></span>';
					 * }else{ strhtml += '<span class="red"><i class="fa
					 * fa-star"
					 * onclick="saveSpecial(&quot;是否取消标记为特殊人员&quot;,&quot;'+
					 * row.id +'&quot;,&quot;'+row.cardnum +'&quot;);"></i></span>'; }
					 */
//            		var badtype="";
//                	badtype+=row.id+"||";
...
//                	}
                	...
                	strhtml += '<button class="btn hover-parent version-hide btnbg_sign" e_name="index_all_patients_table_ralationsign"><span class="setIcon iconDis" Userbehavior="A15" onclick="showsign(&quot;'+row.signurl +'&quot;)"></span><b class="hover-content">家属签字</b></button>';
                	strhtml += '<button class="btn hover-parent version-hide btnbg_look" e_name="index_all_patients_table_edit"><span class="setIcon iconWrite" Userbehavior="A16" onclick="openDivid2(&quot;'+row.id +'&quot;)"></span><b class="hover-content">查看/修改</b></button>';
// if(row.status =='已接诊'){
// strhtml += '<span class="setIcon iconDel"
// onclick="backPatient2(&quot;是否确认删除患者本次就诊信息，将患者从系统中删除？&quot;,&quot;'+row.id
// +'&quot;,&quot;'+row.status +'&quot;,&quot;'+row.hisid
...
// }
                	if(row.status =='未接诊'){
                		if(is_print!='已关闭'){
                        	strhtml += '<button class="btn hover-parent version-hide btnbg_print" e_name="index_all_patients_table_print"><span class="list-print-icon" onclick="dayindividshow(&quot;'+row.id +'&quot;);"></span><b class="hover-content">打印分诊单</b></button>';
                    	}
                		if(is_receive!='已关闭'){
                        	strhtml += '<button class="btn hover-parent version-hide btnbg_do" e_name="index_all_patients_table_receive"><span class="setIcon iconTriage" Userbehavior="A10" onclick="receive(&quot;标记已接诊&quot;,&quot;'+ row.id +'&quot;,&quot;'+row.dividtime +'&quot;,&quot;'+row.hisid +'&quot;,&quot;'+row.cardnum +'&quot;,&quot;'+row.savestatus +'&quot;);" id="receive" value=""></span><b class="hover-content">接诊</b></button>';
...
//                	}
                	...
                	if(row.cixu>1){
                    	...
                    	strhtml += '<button class="btn hover-parent version-hide btnbg_look" e_name="index_all_patients_table_edit"><span class="setIcon iconWrite" Userbehavior="A16" onclick="openDivid(&quot;'+row.id +'&quot;)"></span><b class="hover-content">查看/修改</b></button>';
                	}
                	
                	strhtml += '<button class="btn hover-parent version-hide btnbg_del" e_name="index_all_patients_table_del"><span class="setIcon iconDel" Userbehavior="A6" onclick="backPatient(&quot;是否确认删除患者本次就诊信息，将患者从系统中删除？&quot;,&quot;'+row.id +'&quot;,&quot;'+row.hisid +'&quot;,&quot;'+row.cardnum +'&quot;,&quot;'+row.eventid +'&quot;);"></span><b class="hover-content">删除</b></button>';
// return strhtml;
            	}
...
function fitMethod(){
	...
	// var h = $(".containerbody").outerHeight();
	// var h1 = $("footer").outerHeight();
	// var h2 = $(".tableHeader").outerHeight();
	// var h3 = h-h1-h2-20;
...
// $('#temessage').html('');
	if(savestatus=='save'){
		$("#special").html(0);
// var aa = "<div class='clearfix'><p>分诊时间：<span
// id='show_dividtime'></span></p><div class='form-group'>接诊时间：";
// aa +='<div class="input-group date-picker input-daterange"
// data-date="2018-12-12" data-date-format="yyyy-mm-dd">' ;
// aa += '<input id="jiezhen_time" type="text" name="" placeholder="选择时间"
...
// if(da.length>3){
// if(da[2]!="0"){
// Strhtml += "<div class='badtype'><input type='checkbox' Userbehavior='A161'
// name='badtype' checked value='特殊患者'>特殊患者</div>";
// }else{
// Strhtml += "<div class='badtype'><input type='checkbox' Userbehavior='A161'
// name='badtype' value='特殊患者'>特殊患者</div>";
// }
// if(da[3]!="0"){
// Strhtml += "<div class='badtype'><input type='checkbox' Userbehavior='A169'
// name='badtype' checked value='欠费患者'>欠费患者</div>";
// }else{
// Strhtml += "<div class='badtype'><input type='checkbox' Userbehavior='A169'
// name='badtype' value='欠费患者'>欠费患者</div>";
// }
// }else{
// Strhtml += "<div class='badtype'><input type='checkbox' Userbehavior='A161'
// name='badtype' value='特殊患者'>特殊患者</div>";
...
// alert(JSON.parse(teshu));
						 if(teshu.indexOf(item.id) != -1 ){
							 ...
							 // html = "<div class='badtype'><input
								// type='checkbox' name='badtype'
								// value='"+item.addr+"'
								// checked>"+item.name+"</div>";
						 }else{
...
/*
 * function aa(){ $.ajax({ type: "post", url: "#path()/index/queryRoomList",
 * data:{ }, dataType: "json", async:false, success: function(result){ //基础参数赋值 },
 * error: function(){ } }); } function bb(){ $.ajax({ type: "post", url:
 * "#path()/index/queryRoomWaitList", data:{ room_id:1001 }, dataType: "json",
 * async:false, success: function(result){ //基础参数赋值 }, error: function(){ } }); }
 */