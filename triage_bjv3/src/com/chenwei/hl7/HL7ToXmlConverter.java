...
public class HL7ToXmlConverter {
	...
	//获取 监测数据的 list OBX
	public static List<Map<String,String>> ConvertToList(String sHL7){
        ...
        for (int i = 0; i < sHL7Lines.length; i++)
        {
            ...
            if (sHL7Lines[i] != null)
            {
                ...
                String startStr = sFields[0];
                if(StrUtil.equals(startStr, "OBX")){
                	
                	Map<String,String> m = new HashMap<String,String>();
                	m.put("name", sFields[3]);
                	m.put("value", sFields[5]);
                	list.add(m);
                }
